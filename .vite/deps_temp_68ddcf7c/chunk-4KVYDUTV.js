...
function dataSlice(data, start, end) {
  ...
  return hexlify(
    bytes2.slice(start == null ? 0 : start, end == null ? bytes2.length : end)
  );
}
...
function createGetUrl(options) {
  async function getUrl(req, _signal2) {
    assert(
      _signal2 == null || !_signal2.cancelled,
...
var _FetchRequest = class _FetchRequest {
  ...
  get headers() {
    ...
    if (__privateGet(this, _creds)) {
      headers["authorization"] = `Basic ${encodeBase64(
        toUtf8Bytes(__privateGet(this, _creds))
      )}`;
    }
    if (this.allowGzip) {
  ...
  toString() {
    return `<FetchRequest method=${JSON.stringify(
      ...
      __privateGet(this, _body) ? hexlify(__privateGet(this, _body)) : "null"
    }>`;
  }
  /**
  ...
  send() {
    assert(
      __privateGet(this, _signal) == null,
      "request already sent",
      "UNSUPPORTED_OPERATION",
      { operation: "fetchRequest.send" }
    );
    __privateSet(this, _signal, new FetchCancelSignal(this));
    return __privateMethod(this, _FetchRequest_instances, send_fn).call(
      this,
      0,
  ...
  redirect(location) {
    ...
    __privateSet(
      req,
      _headers,
      Object.assign({}, __privateGet(this, _headers))
    );
  ...
  clone() {
    ...
    __privateSet(
      clone,
      _throttle,
      Object.assign({}, __privateGet(this, _throttle))
    );
  ...
  if (response.statusCode === 301 || response.statusCode === 302) {
    try {
      ...
      return __privateMethod(
        (_a2 = req.redirect(location)),
        _FetchRequest_instances,
        send_fn
      ).call(_a2, attempt + 1, expires, 0, _request3, response);
    } catch (error) {}
    return response;
    ...
    if (
      ...
      let delay2 =
        __privateGet(this, _throttle).slotInterval *
      ...
      return __privateMethod(
        ...
        _FetchRequest_instances,
        send_fn
      ).call(_b, attempt + 1, expires, delay2, _request3, response);
    }
  }
  if (this.processFunc) {
    checkSignal(__privateGet(_request3, _signal));
    try {
      ...
      return __privateMethod(
        ...
        _FetchRequest_instances,
        send_fn
      ).call(_c, attempt + 1, expires, delay2, _request3, response);
    }
  }
  return response;
};
...
var _FetchResponse = class _FetchResponse {
  constructor(statusCode, statusMessage, headers, body, request) {
    ...
    __privateSet(
      this,
      _headers2,
      Object.keys(headers).reduce((accum, k) => {
  ...
  toString() {
    return `<FetchResponse status=${this.statusCode} body=${
      __privateGet(this, _body2) ? hexlify(__privateGet(this, _body2)) : "null"
    }>`;
  }
  /**
  ...
  get body() {
    return __privateGet(this, _body2) == null
      ? null
      : new Uint8Array(__privateGet(this, _body2));
  }
  /**
  ...
  get bodyText() {
    try {
      return __privateGet(this, _body2) == null
        ? ""
        : toUtf8String(__privateGet(this, _body2));
    } catch (error) {
      assert(
        false,
  ...
  makeServerError(message, error) {
    ...
    const response = new _FetchResponse(
      599,
      statusMessage,
      this.headers,
      this.body,
      __privateGet(this, _request) || void 0
    );
  ...
  throwThrottleError(message, stall5) {
    if (stall5 == null) {
      ...
      assertArgument(
        Number.isInteger(stall5) && stall5 >= 0,
  ...
  ok() {
    return (
      __privateGet(this, _error).message === "" &&
      this.statusCode >= 200 &&
      this.statusCode < 300
    );
  }
...
function getFormat(value) {
  ...
  const name =
    (signed2 ? "" : "u") + "fixed" + String(width) + "x" + String(decimals);
...
var _FixedNumber = class _FixedNumber {
   ...
   */
  addUnsafe(other) {
    return __privateMethod(this, _FixedNumber_instances, add_fn).call(
      this,
      other
    );
  }
   ...
   */
  subUnsafe(other) {
    return __privateMethod(this, _FixedNumber_instances, sub_fn).call(
      this,
      other
    );
  }
   ...
   */
  mulUnsafe(other) {
    return __privateMethod(this, _FixedNumber_instances, mul_fn).call(
      this,
      other
    );
  }
   ...
   */
  mulSignal(other) {
    __privateMethod(this, _FixedNumber_instances, checkFormat_fn).call(
      this,
      other
    );
    const value = __privateGet(this, _val) * __privateGet(other, _val);
    assert(
      value % __privateGet(this, _tens) === BN_03,
    ...
    return __privateMethod(this, _FixedNumber_instances, checkValue_fn).call(
      this,
      value / __privateGet(this, _tens),
      "mulSignal"
    );
  }
  /**
   ...
   */
  divUnsafe(other) {
    return __privateMethod(this, _FixedNumber_instances, div_fn).call(
      this,
      other
    );
  }
  ...
  divSignal(other) {
    ...
    assert(
      value % __privateGet(other, _val) === BN_03,
  ...
  floor() {
    ...
    val =
      (__privateGet(this, _val) / __privateGet(this, _tens)) *
      __privateGet(this, _tens);
    return __privateMethod(this, _FixedNumber_instances, checkValue_fn).call(
      this,
      val,
      "floor"
...
add_fn = function (o, safeOp) {
  ...
  return __privateMethod(this, _FixedNumber_instances, checkValue_fn).call(
    this,
    __privateGet(this, _val) + __privateGet(o, _val),
    safeOp
  );
};
...
function getValue(value) {
  ...
  if (bytes2.length !== WordSize) {
    bytes2 = getBytesCopy(
      concat([Padding.slice(bytes2.length % WordSize), bytes2])
    );
  }
  return bytes2;
}
...
var Writer = class {
  ...
  appendWriter(writer) {
    return __privateMethod(this, _Writer_instances, writeData_fn).call(
      this,
      getBytesCopy(writer.data)
    );
  }
...
writeData_fn = function (data) {
  ...
  __privateSet(
    this,
    _dataLength,
    __privateGet(this, _dataLength) + data.length
  );
  return data.length;
};
var _data2,
...
var _Reader = class _Reader {
  constructor(data, allowLoose, maxInflation) {
    ...
    __privateSet(
      this,
      _maxInflation,
      maxInflation != null ? maxInflation : 1024
    );
  ...
  subReader(offset) {
    const reader = new _Reader(
      __privateGet(this, _data2).slice(__privateGet(this, _offset) + offset),
      this.allowLoose,
      __privateGet(this, _maxInflation)
    );
  ...
  readBytes(length, loose) {
    let bytes2 = __privateMethod(this, _Reader_instances, peekBytes_fn).call(
      this,
      0,
      length,
      !!loose
    );
    __privateMethod(this, _Reader_instances, incrementBytesRead_fn).call(
      this,
      length
    );
...
incrementBytesRead_fn = function (count) {
  ...
  assert(
    __privateGet(this, _maxInflation) < 1 ||
      __privateGet(this, _bytesRead) <=
        __privateGet(this, _maxInflation) * this.dataLength,
    `compressed ABI data exceeds inflation ratio of ${__privateGet(
      this,
      _maxInflation
...
peekBytes_fn = function (offset, length, loose) {
  ...
  if (
    __privateGet(this, _offset) + alignedLength >
    __privateGet(this, _data2).length
  ) {
    if (
      this.allowLoose &&
      loose &&
      __privateGet(this, _offset) + length <= __privateGet(this, _data2).length
    ) {
  ...
  return __privateGet(this, _data2).slice(
...
function bytes(b2, ...lengths) {
  ...
  if (lengths.length > 0 && !lengths.includes(b2.length))
    throw new Error(
      `Expected Uint8Array of length ${lengths}, not of length=${b2.length}`
    );
}
function hash(hash2) {
...
var hexes2 = Array.from({ length: 256 }, (_, i) =>
  i.toString(16).padStart(2, "0")
);
...
function nLength(n2, nBitLength) {
  const _nBitLength =
    nBitLength !== void 0 ? nBitLength : n2.toString(2).length;
...
function Field(ORDER, bitLen2, isLE2 = false, redef = {}) {
  ...
  const f2 = Object.freeze({
    ...
    // Proposal: do we really need constant cmov?
...
function weierstrass(curveDef) {
  ...
  class Signature2 {
    ...
    normalizeS() {
      return this.hasHighS()
        ? new Signature2(this.r, modN2(-this.s), this.recovery)
        : this;
    }
    // DER-encoded
    toDERRawBytes() {
  ...
  function verify(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    if (lowS && _sig2.hasHighS()) return false;
    ...
    const u2 = modN2(r * is);
    const R =
      (_a2 = Point2.BASE.multiplyAndAddUnsafe(P, u1, u2)) == null
        ? void 0
        : _a2.toAffine();
    if (!R) return false;
    const v = modN2(R.x);
...
var _SigningKey = class _SigningKey {
  ...
  sign(digest) {
    ...
    const sig = secp256k1.sign(
      getBytesCopy(digest),
      getBytesCopy(__privateGet(this, _privateKey)),
      {
        lowS: true,
      }
    );
  ...
  static addPoints(p0, p1, compressed) {
    const pub0 = secp256k1.ProjectivePoint.fromHex(
      _SigningKey.computePublicKey(p0).substring(2)
    );
    const pub1 = secp256k1.ProjectivePoint.fromHex(
      _SigningKey.computePublicKey(p1).substring(2)
    );
...
var StringCoder = class extends DynamicBytesCoder {
  ...
  encode(writer, _value2) {
    return super.encode(
      writer,
      toUtf8Bytes(Typed.dereference(_value2, "string"))
    );
  }
  decode(reader) {
    ...
    switch (x - offset) {
      case 3:
        return (
          offset +
          65792 +
          ((bytes2[pos_payload++] << 16) |
            (bytes2[pos_payload++] << 8) |
            bytes2[pos_payload++])
        );
      case 2:
        return (
          offset + 256 + ((bytes2[pos_payload++] << 8) | bytes2[pos_payload++])
        );
      case 1:
...
function flatten(split3) {
  return split3
    .map(({ input, error, output: output2 }) => {
      if (error) {
        ...
        if (j - i > NSM_MAX) {
          throw new Error(
            `excessive non-spacing marks: ${bidi_qq(
              safe_str_from_cps(decomposed2.slice(i - 1, j))
            )} (${j - i}/${NSM_MAX})`
          );
        }
        i = j;
...
function _parseLegacy(data) {
  ...
  if (r === BN_07 && s === BN_07) {
    ...
    tx.chainId = chainId;
    assertArgument(
      chainId !== BN_07 || v === BN_272 || v === BN_282,
...
var _Transaction = class _Transaction {
  ...
  set accessList(value) {
    __privateSet(
      this,
      _accessList,
      value == null ? null : accessListify(value)
    );
  }
  /**
  ...
  set blobs(_blobs2) {
    ...
    for (let i = 0; i < _blobs2.length; i++) {
      ...
      if (isBytesLike(blob)) {
        ...
        const proof = hexlify(
          __privateGet(this, _kzg).computeBlobKzgProof(data, commit)
        );
        blobs.push({
          data: hexlify(data),
  ...
  get hash() {
    ...
    return keccak256(
      __privateMethod(this, _Transaction_instances, getSerialized_fn).call(
        this,
        true,
        false
      )
   ...
   */
  get serialized() {
    return __privateMethod(this, _Transaction_instances, getSerialized_fn).call(
      this,
      true,
      true
    );
  ...
  inferTypes() {
    ...
    const hasBlob =
      __privateGet(this, _maxFeePerBlobGas) != null ||
      __privateGet(this, _blobVersionedHashes);
...
var _TypedDataEncoder = class _TypedDataEncoder {
  ...
  constructor(_types2) {
    ...
    for (const [name, set] of subtypes) {
      ...
      st.sort();
      __privateGet(this, _fullTypes).set(
        name,
  ...
  static hashDomain(domain) {
    ...
    domainFields.sort((a, b2) => {
      return (
        domainFieldNames.indexOf(a.name) - domainFieldNames.indexOf(b2.name)
      );
    });
...
var _TokenString = class _TokenString {
  ...
  popParen() {
    ...
    const result = __privateMethod(
      this,
      _TokenString_instances,
      subTokenString_fn
    ).call(this, __privateGet(this, _offset2) + 1, top.match + 1);
  ...
  popParams() {
    ...
    while (__privateGet(this, _offset2) < top.match - 1) {
      ...
      result.push(
        __privateMethod(this, _TokenString_instances, subTokenString_fn).call(
          this,
          __privateGet(this, _offset2) + 1,
          link
        )
      );
  ...
  toString() {
    const tokens = [];
    for (
      let i = __privateGet(this, _offset2);
      i < __privateGet(this, _tokens).length;
      i++
    ) {
...
subTokenString_fn = function (from = 0, to = 0) {
  return new _TokenString(
    __privateGet(this, _tokens)
      .slice(from, to)
      .map((t) => {
        return Object.freeze(
          Object.assign({}, t, {
...
var _ParamType = class _ParamType {
  ...
  format(format) {
    ...
    if (format === "json") {
      ...
      if (this.isTuple()) {
        result2.components = this.components.map((c) =>
  ...
  async walkAsync(value, process) {
    const promises = [];
    const result = [value];
    __privateMethod(this, _ParamType_instances, walkAsync_fn).call(
      this,
      promises,
      value,
      process,
  ...
  static from(obj, allowIndexed) {
    ...
    if (
      ...
      const comps =
        obj.components != null
          ? obj.components.map((c) => _ParamType.from(c))
          : null;
      const tuple = new _ParamType(
        _guard4,
        name || "",
        type,
        "tuple",
  ...
  if (this.isArray()) {
    ...
    result2.forEach((value2, index) => {
      ...
      __privateMethod(
        ...
        walkAsync_fn
      ).call(_a2, promises, value2, process, (value3) => {
...
var ConstructorFragment = class _ConstructorFragment extends Fragment {
  ...
  static from(obj) {
    ...
    if (typeof obj === "string") {
      ...
      consumeEoi(obj);
      return new _ConstructorFragment(
        _guard4,
        "constructor",
        inputs,
        payable,
...
var FunctionFragment = class _FunctionFragment extends NamedFragment {
  ...
  static getSelector(name, params) {
    params = (params || []).map((p) => ParamType.from(p));
    const fragment = new _FunctionFragment(
      _guard4,
      name,
      "view",
      params,
...
var StructFragment = class _StructFragment extends NamedFragment {
  ...
  static from(obj) {
    ...
    return new _StructFragment(
      _guard4,
      obj.name,
      obj.inputs ? obj.inputs.map(ParamType.from) : []
    );
  }
  // @Proposal: fix this return type
  /**
   *  Returns ``true`` and provides a type guard if %%value%% is a
   *  **StructFragment**.
   */
...
var _AbiCoder = class _AbiCoder {
  ...
  getDefaultValue(types) {
    const coders = types.map((type) =>
      __privateMethod(this, _AbiCoder_instances, getCoder_fn).call(
        this,
        ParamType.from(type)
      )
    );
  ...
  if (param.isTuple()) {
    return new TupleCoder(
      param.components.map((c) =>
        __privateMethod(this, _AbiCoder_instances, getCoder_fn).call(this, c)
      ),
      param.name
    );
  }
...
var _Interface = class _Interface {
   ...
   */
  getFunctionName(key) {
    const fragment = __privateMethod(
      this,
      _Interface_instances,
      getFunction_fn
    ).call(this, key, null, false);
   ...
   */
  hasFunction(key) {
    return !!__privateMethod(this, _Interface_instances, getFunction_fn).call(
      this,
      key,
      null,
      false
   ...
   */
  hasEvent(key) {
    return !!__privateMethod(this, _Interface_instances, getEvent_fn).call(
      this,
      key,
      null,
      false
  ...
  */
  ...
  makeError(_data5, tx) {
    ...
    if (error.message.startsWith(customPrefix)) {
      ...
      if (ef) {
        try {
          const args = __privateGet(this, _abiCoder).decode(
            ef.inputs,
            data.slice(4)
          );
          error.revert = {
  ...
  encodeFunctionResult(fragment, values) {
    ...
    return hexlify(
      __privateGet(this, _abiCoder).encode(fragment.outputs, values || [])
    );
  }
  /*
  ...
  */
    ...
    fragment.inputs.forEach((param, index) => {
      ...
      if (param.indexed) {
        if (param.type === "string") {
          ...
          topics.push(
            __privateGet(this, _abiCoder).encode([param.type], [value])
          );
        }
      } else {
  ...
  decodeEventLog(fragment, data, topics) {
    ...
    const resultIndexed =
      topics != null
        ? __privateGet(this, _abiCoder).decode(indexed, concat(topics))
        : null;
    const resultNonIndexed = __privateGet(this, _abiCoder).decode(
      nonIndexed,
      data,
      true
    );
...
getFunction_fn = function (key, values, forceUnique) {
  ...
  const result = __privateGet(this, _functions).get(
...
getEvent_fn = function (key, values, forceUnique) {
  ...
  const result = __privateGet(this, _events).get(
    EventFragment.from(key).format()
  );
  if (result) {
    return result;
  }
    ...
    const checkReceipt = (receipt2) => {
      ...
      assert(false, "transaction execution reverted", "CALL_EXCEPTION", {
        ...
        transaction: {
          ...
          from: receipt2.from,
          data: "",
          // @Proposal: in v7, split out sendTransaction properties
        },
        receipt: receipt2,
      });
    };
  ...
  get logs() {
    return super.logs.map((log) => {
      const fragment = log.topics.length
        ? __privateGet(this, _iface).getEvent(log.topics[0])
        : null;
      if (fragment) {
        try {
  ...
  topics = topics.map((t) => {
    ...
    if (Array.isArray(t)) {
      const items = Array.from(
        new Set(t.map((t2) => t2.toLowerCase())).values()
      );
      if (items.length === 1) {
        return items[0];
      }
...
var _BaseContract = class _BaseContract {
    ...
    const filters = new Proxy(
      {},
      {
        ...
        has: (target2, prop) => {
          ...
          return (
            Reflect.has(target2, prop) || this.interface.hasEvent(String(prop))
          );
        },
      }
    );
    ...
    return new Proxy(this, {
      get: (target2, prop, receiver) => {
        if (
          typeof prop === "symbol" ||
          prop in target2 ||
          passProperties2.indexOf(prop) >= 0
        ) {
          return Reflect.get(target2, prop, receiver);
        }
        try {
  ...
  /*
      // @Proposal: this is a non-backwards compatible change, but will be added
  ...
  async off(event, listener) {
    ...
    if (listener) {
      const index = sub.listeners
        .map(({ listener: listener2 }) => listener2)
        .indexOf(listener);
      if (index >= 0) {
...
var _EnsResolver = class _EnsResolver {
  ...
  async supportsWildcard() {
    if (__privateGet(this, _supports2544) == null) {
      __privateSet(
        ...
        (async () => {
          try {
            return await __privateGet(this, _resolver).supportsInterface(
              "0x9061b923"
            );
          } catch (error) {
  ...
  async getAddress(coinType) {
    ...
    if (coinType >= 0 && coinType < 2147483648) {
      ...
      const data2 = await __privateMethod(
        this,
        _EnsResolver_instances,
        fetch_fn
      ).call(this, "addr(bytes32,uint)", [ethCoinType]);
    ...
    const data = await __privateMethod(
      this,
      _EnsResolver_instances,
      fetch_fn
    ).call(this, "addr(bytes32,uint)", [coinType]);
  ...
  async getText(key) {
    const data = await __privateMethod(
      ...
      _EnsResolver_instances,
      fetch_fn
    ).call(this, "text(bytes32,string)", [key]);
    if (data == null || data === "0x") {
      return null;
    }
    return data;
  ...
  static async fromName(provider, name) {
    ...
    while (true) {
      ...
      const addr = await __privateMethod(
        (_a2 = _EnsResolver),
        _EnsResolver_static,
        getResolver_fn
      ).call(_a2, provider, currentName);
      if (addr != null) {
...
var PollingBlockSubscriber = class {
  ...
  start() {
    ...
    __privateSet(
      this,
      _poller,
      __privateGet(this, _provider)._setTimeout(
        __privateMethod(this, _PollingBlockSubscriber_instances, poll_fn).bind(
          this
        ),
        __privateGet(this, _interval)
      )
    );
    __privateMethod(this, _PollingBlockSubscriber_instances, poll_fn).call(
      this
    );
  }
  stop() {
...
poll_fn = async function () {
  try {
    ...
    if (blockNumber !== __privateGet(this, _blockNumber)) {
      for (
        let b2 = __privateGet(this, _blockNumber) + 1;
        b2 <= blockNumber;
        b2++
      ) {
...
var _provider3,
  ...
  _running2,
  _blockNumber2,
  _PollingEventSubscriber_instances,
  poll_fn2;
var PollingEventSubscriber = class {
  ...
  constructor(provider, filter) {
    ...
    __privateSet(
      this,
      _poller2,
      __privateMethod(this, _PollingEventSubscriber_instances, poll_fn2).bind(
        this
      )
    );
...
var AbstractProvider = class {
  ...
  async getBlockNumber() {
    const blockNumber = getNumber(
      await __privateMethod(this, _AbstractProvider_instances, perform_fn).call(
        this,
  ...
  async getFeeData() {
    ...
    const getFeeDataFunc = async () => {
      const { _block, gasPrice, priorityFee } = await resolveProperties({
        _block: __privateMethod(
          this,
          _AbstractProvider_instances,
          getBlock_fn
        ).call(this, "latest", false),
        gasPrice: (async () => {
          try {
        ...
        priorityFee: (async () => {
          try {
            const value = await __privateMethod(
              ...
              _AbstractProvider_instances,
              perform_fn
            ).call(this, { method: "getPriorityFee" });
            return getBigInt(value, "%response");
          } catch (error) {}
          return null;
        })(),
  ...
  async call(_tx) {
    ...
    return await __privateMethod(
      ...
      this,
      __privateMethod(this, _AbstractProvider_instances, call_fn).call(
        this,
        tx,
        blockTag,
        _tx.enableCcipRead ? 0 : -1
      )
    );
  }
  async getBalance(address, blockTag) {
    return getBigInt(
      await __privateMethod(
        ...
        _AbstractProvider_instances,
        getAccountValue_fn
      ).call(this, { method: "getBalance" }, address, blockTag),
      "%response"
    );
  }
  async getTransactionCount(address, blockTag) {
    return getNumber(
      await __privateMethod(
        ...
        _AbstractProvider_instances,
        getAccountValue_fn
      ).call(this, { method: "getTransactionCount" }, address, blockTag),
      "%response"
    );
  }
  async getCode(address, blockTag) {
    return hexlify(
      await __privateMethod(
        ...
        _AbstractProvider_instances,
        getAccountValue_fn
      ).call(this, { method: "getCode" }, address, blockTag)
    );
  }
  async getStorage(address, _position, blockTag) {
    ...
    return hexlify(
      await __privateMethod(
        ...
        _AbstractProvider_instances,
        getAccountValue_fn
      ).call(this, { method: "getStorage", position }, address, blockTag)
    );
  }
  // Write
  async broadcastTransaction(signedTx) {
    ...
    if (tx.hash !== hash2) {
      throw new Error("@Proposal: the returned hash did not match");
    }
  ...
  async getBlock(block, prefetchTxs) {
    const { network, params } = await resolveProperties({
      network: this.getNetwork(),
      params: __privateMethod(
        this,
        _AbstractProvider_instances,
        getBlock_fn
      ).call(this, block, !!prefetchTxs),
    });
    if (params == null) {
      return null;
    }
  ...
  async getTransaction(hash2) {
    const { network, params } = await resolveProperties({
      ...
      params: __privateMethod(
        ...
        _AbstractProvider_instances,
        perform_fn
      ).call(this, { method: "getTransaction", hash: hash2 }),
    });
    if (params == null) {
      return null;
    }
  ...
  async getTransactionReceipt(hash2) {
    const { network, params } = await resolveProperties({
      ...
      params: __privateMethod(
        ...
        _AbstractProvider_instances,
        perform_fn
      ).call(this, { method: "getTransactionReceipt", hash: hash2 }),
    });
    if (params == null) {
      return null;
    }
    if (params.gasPrice == null && params.effectiveGasPrice == null) {
      const tx = await __privateMethod(
        this,
        _AbstractProvider_instances,
        perform_fn
      ).call(this, { method: "getTransaction", hash: hash2 });
  ...
  async getTransactionResult(hash2) {
    const { result } = await resolveProperties({
      ...
      result: __privateMethod(
        ...
        _AbstractProvider_instances,
        perform_fn
      ).call(this, { method: "getTransactionResult", hash: hash2 }),
    });
    if (result == null) {
      return null;
    }
  ...
  async getLogs(_filter5) {
    ...
    const { network, params } = await resolveProperties({
      ...
      params: __privateMethod(
        ...
        _AbstractProvider_instances,
        perform_fn
      ).call(this, { method: "getLogs", filter }),
    });
  ...
  _setTimeout(_func, timeout) {
    ...
    if (this.paused) {
      __privateGet(this, _timers).set(timerId, {
        timer: null,
        func,
        time: timeout,
      });
  ...
  async on(event, listener) {
    const sub = await __privateMethod(
      this,
      _AbstractProvider_instances,
      getSub_fn
    ).call(this, event);
  ...
  async removeAllListeners(event) {
    if (event) {
      const { tag, started, subscriber } = await __privateMethod(
        this,
        _AbstractProvider_instances,
        getSub_fn
      ).call(this, event);
    ...
    if (
      ...
      try {
        const result = await __privateMethod(
          ...
          _AbstractProvider_instances,
          call_fn
        ).call(this, tx2, blockTag, attempt + 1);
        this.emit("debug", {
...
getAccountValue_fn = async function (request, _address, _blockTag) {
  ...
  return await __privateMethod(
    ...
    this,
    __privateMethod(this, _AbstractProvider_instances, perform_fn).call(
      this,
      Object.assign(request, { address, blockTag })
    )
  );
};
...
async function populate(signer, tx) {
  ...
  if (pop.from != null) {
    ...
    pop.from = Promise.all([
      ...
      assertArgument(
        address.toLowerCase() === from2.toLowerCase(),
...
var _VoidSigner = class _VoidSigner extends AbstractSigner {
  ...
  async signTransaction(tx) {
    __privateMethod(this, _VoidSigner_instances, throwUnsupported_fn).call(
      this,
      "transactions",
      "signTransaction"
    );
...
var FilterIdSubscriber = class {
  ...
  constructor(provider) {
    ...
    __privateSet(
      this,
      _poller3,
      __privateMethod(this, _FilterIdSubscriber_instances, poll_fn3).bind(this)
    );
  ...
  start() {
    ...
    __privateMethod(this, _FilterIdSubscriber_instances, poll_fn3).call(
      this,
      -2
    );
  }
  stop() {
    ...
    __privateMethod(this, _FilterIdSubscriber_instances, teardown_fn).call(
      this
    );
...
poll_fn3 = async function (blockNumber) {
  try {
    ...
    if (filterId == null) {
      __privateSet(this, _filterIdPromise, null);
      __privateGet(this, _provider4)._recoverSubscriber(
        this,
        this._recover(__privateGet(this, _provider4))
      );
      return;
    }
    ...
    const result = await __privateGet(this, _provider4).send(
...
var _options3,
  ...
  _notReady,
  _network2,
  _pendingDetectNetwork,
  _JsonRpcApiProvider_instances,
  scheduleDrain_fn;
var JsonRpcApiProvider = class extends AbstractProvider {
  ...
  _start() {
    if (
      __privateGet(this, _notReady) == null ||
      __privateGet(this, _notReady).resolve == null
    ) {
      return;
    }
  ...
  send(method, params) {
    ...
    __privateMethod(this, _JsonRpcApiProvider_instances, scheduleDrain_fn).call(
      this
    );
    return promise;
  }
...
var AlchemyProvider = class _AlchemyProvider extends JsonRpcProvider {
  ...
  static getRequest(network, apiKey) {
    ...
    const request = new FetchRequest(
      `https://${getHost2(network.name)}/v2/${apiKey}`
    );
    request.allowGzip = true;
...
var ChainstackProvider = class _ChainstackProvider extends JsonRpcProvider {
  ...
  static getRequest(network, apiKey) {
    ...
    const request = new FetchRequest(
      `https://${getHost3(network.name)}/${apiKey}`
    );
    request.allowGzip = true;
...
var EtherscanProvider = class extends AbstractProvider {
  ...
  async fetch(module, params, post) {
    ...
    request.processFunc = async (request2, response2) => {
      const result2 = response2.hasBody()
        ? JSON.parse(toUtf8String(response2.body))
        : {};
      const throttle =
        (typeof result2.result === "string" ? result2.result : "")
          .toLowerCase()
...
var SocketSubscriber = class {
  ...
  // @Proposal: pause should trap the current blockNumber, unsub, and on resume use getLogs
  //        and resume
  pause(dropWhilePaused) {
    assert(
      dropWhilePaused,
...
var SocketProvider = class extends JsonRpcApiProvider {
  ...
  */
  ...
  async _send(payload) {
    ...
    const promise = new Promise((resolve, reject) => {
      __privateGet(this, _callbacks).set(payload.id, {
        payload,
        resolve,
        reject,
      });
...
var InfuraProvider = class _InfuraProvider extends JsonRpcProvider {
  ...
  constructor(_network3, projectId, projectSecret) {
    ...
    const request = _InfuraProvider.getRequest(
      network,
      projectId,
      projectSecret
    );
  ...
  static getRequest(network, projectId, projectSecret) {
    ...
    const request = new FetchRequest(
      `https://${getHost4(network.name)}/v3/${projectId}`
    );
    request.allowGzip = true;
    if (projectSecret) {
...
var QuickNodeProvider = class _QuickNodeProvider extends JsonRpcProvider {
  ...
  static getRequest(network, token) {
    ...
    const request = new FetchRequest(
      `https://${getHost5(network.name)}/${token}`
    );
    request.allowGzip = true;
...
var FallbackProvider = class extends AbstractProvider {
  ...
  constructor(providers, network, options) {
    ...
    if (options && options.quorum != null) {
      ...
      this.quorum = Math.ceil(
        __privateGet(this, _configs).reduce((accum, config) => {
          accum += config.weight;
          return accum;
        }, 0) / 2
      );
    ...
    assertArgument(
      this.quorum <=
        __privateGet(this, _configs).reduce((a, c) => a + c.weight, 0),
  ...
  // @Proposal: Add support to select providers to be the event subscriber
  ...
  async _perform(req) {
    ...
    while (true) {
      const runner = __privateMethod(
        this,
        _FallbackProvider_instances,
        addRunner_fn
      ).call(this, running, req);
      if (runner == null) {
        break;
      }
...
waitForQuorum_fn = async function (running, req) {
  ...
  for (let i = 0; i < newRunners; i++) {
    __privateMethod(this, _FallbackProvider_instances, addRunner_fn).call(
      this,
      running,
      req
    );
...
var BrowserProvider = class extends JsonRpcApiPollingProvider {
  ...
  async _send(payload) {
    ...
    try {
      const result = await __privateGet(this, _request2).call(
        this,
        payload.method,
        payload.params || []
      );
  ...
  async getSigner(address) {
    ...
    if (!(await this.hasSigner(address))) {
      try {
        await __privateGet(this, _request2).call(
          this,
          "eth_requestAccounts",
          []
        );
...
var PocketProvider = class _PocketProvider extends JsonRpcProvider {
  ...
  constructor(_network3, applicationId, applicationSecret) {
    ...
    const request = _PocketProvider.getRequest(
      network,
      applicationId,
      applicationSecret
    );
  ...
  static getRequest(network, applicationId, applicationSecret) {
    ...
    const request = new FetchRequest(
      `https://${getHost6(network.name)}/v1/lb/${applicationId}`
    );
    request.allowGzip = true;
...
var _BaseWallet = class _BaseWallet extends AbstractSigner {
  ...
  // @Proposal: Add a secialized signTx and signTyped sync that enforces
...
var WordlistOwl = class extends Wordlist {
  ...
  getWord(index) {
    const words2 = __privateMethod(
      this,
      _WordlistOwl_instances,
      loadWords_fn
    ).call(this);
    assertArgument(
      index >= 0 && index < words2.length,
  ...
  getWordIndex(word) {
    return __privateMethod(this, _WordlistOwl_instances, loadWords_fn)
      .call(this)
      .indexOf(word);
  }
};
...
function mnemonicToEntropy(mnemonic, wordlist2) {
  ...
  assertArgument(
    words2.length % 3 === 0 && words2.length >= 12 && words2.length <= 24,
  ...
  const checksum2 =
    getBytes(sha2562(entropy.slice(0, entropyBits / 8)))[0] & checksumMask;
  assertArgument(
    checksum2 === (entropy[entropy.length - 1] & checksumMask),
...
function entropyToMnemonic(entropy, wordlist2) {
  ...
  const checksum2 =
    parseInt(sha2562(entropy).substring(2, 4), 16) & getUpperMask(checksumBits);
  ...
  constructor(key) {
    ...
    for (let r = 1; r < rounds; r++) {
      for (let c = 0; c < 4; c++) {
        ...
        __classPrivateFieldGet(this, _AES_Kd, "f")[r][c] =
          U1[(tt >> 24) & 255] ^
          U2[(tt >> 16) & 255] ^
          U3[(tt >> 8) & 255] ^
          U4[tt & 255];
...
(_AES_key = /* @__PURE__ */ new WeakMap()),
  (_AES_Kd = /* @__PURE__ */ new WeakMap()),
  (_AES_Ke = /* @__PURE__ */ new WeakMap());
...
var CBC = class _CBC extends ModeOfOperation {
  ...
  encrypt(plaintext) {
    ...
    for (let i = 0; i < plaintext.length; i += 16) {
      for (let j = 0; j < 16; j++) {
        __classPrivateFieldGet2(this, _CBC_lastBlock, "f")[j] ^=
          plaintext[i + j];
      }
      __classPrivateFieldSet2(
        this,
        _CBC_lastBlock,
        this.aes.encrypt(__classPrivateFieldGet2(this, _CBC_lastBlock, "f")),
        "f"
      );
  ...
  decrypt(ciphertext) {
    ...
    for (let i = 0; i < ciphertext.length; i += 16) {
      ...
      for (let j = 0; j < 16; j++) {
        plaintext[i + j] =
          block[j] ^ __classPrivateFieldGet2(this, _CBC_lastBlock, "f")[j];
        __classPrivateFieldGet2(this, _CBC_lastBlock, "f")[j] =
          ciphertext[i + j];
      }
    }
...
(_CBC_iv = /* @__PURE__ */ new WeakMap()),
  (_CBC_lastBlock = /* @__PURE__ */ new WeakMap());
...
var _CFB_shift;
(_CFB_iv = /* @__PURE__ */ new WeakMap()),
  (_CFB_shiftRegister = /* @__PURE__ */ new WeakMap()),
  (_CFB_instances = /* @__PURE__ */ new WeakSet()),
  (_CFB_shift = function _CFB_shift2(data) {
    const segmentSize = this.segmentSize / 8;
    __classPrivateFieldGet3(this, _CFB_shiftRegister, "f").set(
      __classPrivateFieldGet3(this, _CFB_shiftRegister, "f").subarray(
        segmentSize
      )
    );
    __classPrivateFieldGet3(this, _CFB_shiftRegister, "f").set(
...
var CTR = class _CTR extends ModeOfOperation {
  constructor(key, initialValue) {
    ...
    __classPrivateFieldSet3(
      this,
      _CTR_remaining,
      __classPrivateFieldGet4(this, _CTR_counter, "f"),
      "f"
    );
    ...
    for (let i = 0; i < crypttext.length; i++) {
      if (__classPrivateFieldGet4(this, _CTR_remainingIndex, "f") === 16) {
        __classPrivateFieldSet3(
          this,
          _CTR_remaining,
          this.aes.encrypt(__classPrivateFieldGet4(this, _CTR_counter, "f")),
          "f"
        );
        __classPrivateFieldSet3(this, _CTR_remainingIndex, 0, "f");
        this.increment();
      }
      crypttext[i] ^= __classPrivateFieldGet4(this, _CTR_remaining, "f")[
        (__classPrivateFieldSet3(
          this,
          _CTR_remainingIndex,
          ((_b = __classPrivateFieldGet4(this, _CTR_remainingIndex, "f")),
          (_a2 = _b++),
          _b),
          "f"
        ),
...
(_CTR_remaining = /* @__PURE__ */ new WeakMap()),
  (_CTR_remainingIndex = /* @__PURE__ */ new WeakMap()),
  (_CTR_counter = /* @__PURE__ */ new WeakMap());

// node_modules/aes-js/lib.esm/mode-ofb.js
var _OFB_iv;
var _OFB_lastPrecipher;
var _OFB_lastPrecipherIndex;
(_OFB_iv = /* @__PURE__ */ new WeakMap()),
  (_OFB_lastPrecipher = /* @__PURE__ */ new WeakMap()),
  (_OFB_lastPrecipherIndex = /* @__PURE__ */ new WeakMap());
...
function getEncryptKdfParams(options) {
  ...
  assertArgument(
    typeof N3 === "number" &&
      ...
      (BigInt(N3) & BigInt(N3 - 1)) === BigInt(0),
...
function _encryptKeystore(key, kdf, account, options) {
  ...
  const iv =
    options.iv != null ? getBytes(options.iv, "options.iv") : randomBytes3(16);
  assertArgument(
    iv.length === 16,
...
var _HDNodeWallet = class _HDNodeWallet extends BaseWallet {
  ...
  async encrypt(password, progressCallback) {
    return await encryptKeystoreJson(
      __privateMethod(this, _HDNodeWallet_instances, account_fn).call(this),
      password,
      { progressCallback }
    );
  }
  ...
  deriveChild(_index) {
    ...
    const ki = new SigningKey(
      toBeHex((toBigInt(IL) + BigInt(this.privateKey)) % N2, 32)
    );
    return new _HDNodeWallet(
      _guard6,
      ki,
  ...
  static fromExtendedKey(extendedKey) {
    ...
    assertArgument(
      bytes2.length === 82 ||
        encodeBase58Check(bytes2.slice(0, 78)) === extendedKey,
  ...
  static createRandom(password, path, wordlist2) {
    ...
    return __privateMethod(
      (_a2 = _HDNodeWallet),
      _HDNodeWallet_static,
      fromSeed_fn
    )
      .call(_a2, mnemonic.computeSeed(), mnemonic)
      .derivePath(path);
  }
  /**
...
function decryptCrowdsaleJson(json, _password) {
  ...
  const key = getBytes(pbkdf22(password, password, 2e3, 32, "sha256")).slice(
    0,
    16
  );
...
fromAccount_fn = function (account) {
  ...
  if (
    ...
    if (
      wallet2.address === account.address &&
      wallet2.privateKey === account.privateKey
    ) {
      return wallet2;
    }
    console.log(
...
*/
//# sourceMappingURL=chunk-4KVYDUTV.js.map
