...
const useCompleteProposal = () => {
  ...
  return useCallback(
    async (index) => {
      ...
      try {
        const estimatedGas = await contract.voteOnProposal.estimateGas(
          index
        );
        ...
        console.error("Error updating Proposal:", decodedError);
...
export default useCompleteProposal;
